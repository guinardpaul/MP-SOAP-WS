/* ----------------------------------
    	Classes
   ---------------------------------- */
INSERT INTO classes (id, classe_cycle, classe_name) VALUES
(1, "Cycle 3", "6_G1"),
(2, "Cycle 3", "6_G2"),
(3, "Cycle 3", "6_G3"),
(4, "Cycle 3", "6_G4"),
...
/* ----------------------------------
		Résultats
  ---------------------------------- */
INSERT INTO resultats (results, competence_id, eleve_id) VALUES
("++", 2, 5),
("+", 3, 5),
("+/-", 4, 5),
("-", 5, 5);
...
(20, null, "Pratiquer des démarches scientifiques et technologiques", "Cycle 3", 19);
-- Competences domaine 4-sous_domaine 1
INSERT INTO competences (id, ref, description, cycle, abstract_domaine_id) VALUES
...
-- Sous_domaine 2
INSERT INTO domaines (id, ref, description, cycle, abstract_domaine_id) VALUES
(27, null, "Conception, création, réalisation", "Cycle 3", 19);
-- Competences domaine 4-sous_domaine 2
INSERT INTO competences (id, ref, description, cycle, abstract_domaine_id) VALUES
...
-- Sous_domaine 3
INSERT INTO domaines (id, ref, description, cycle, abstract_domaine_id) VALUES
(32, null, "Mettre en pratique des comportements simples respectueux des autres, de l'environnement, de sa santé", "Cycle 3", 19);
-- Competences domaine 4-sous_domaine 3
INSERT INTO competences (id, ref, description, cycle, abstract_domaine_id) VALUES
...
-- sous_domaine 1
INSERT INTO domaines (id, ref, description, cycle, abstract_domaine_id) VALUES
(46, null, "Organiser son travail personnel", "Cycle 4", 45);
-- Competences domaine 2 - sous_domaine 1
INSERT INTO competences (id, ref, description, cycle, abstract_domaine_id) VALUES
...
-- sous_domaine 2
INSERT INTO domaines (id, ref, description, cycle, abstract_domaine_id) VALUES
(48, null, "Coopération et réalisation de projet.", "Cycle 4", 45);
-- Competences domaine 2 - sous_domaine 2
INSERT INTO competences (id, ref, description, cycle, abstract_domaine_id) VALUES
...
-- sous_domaine 3
INSERT INTO domaines (id, ref, description, cycle, abstract_domaine_id) VALUES
(54, null, "S’approprier des outils et méthodes", "Cycle 4", 45);
-- Competences domaine 2 - sous_domaine 3
INSERT INTO competences (id, ref, description, cycle, abstract_domaine_id) VALUES
...
-- sous_domaine 1
INSERT INTO domaines (id, ref, description, cycle, abstract_domaine_id) VALUES
(63, null, "Pratiquer des démarches scientifiques et technologiques", "Cycle 4", 62);
-- Competences domaine 4 - sous_domaine 1
INSERT INTO competences (id, ref, description, cycle, abstract_domaine_id) VALUES
...
-- sous_domaine 2
INSERT INTO domaines (id, ref, description, cycle, abstract_domaine_id) VALUES
(68, null, "Pratiquer des démarches scientifiques et technologiques", "Cycle 4", 62);
-- Competences domaine 4 - sous_domaine 2
INSERT INTO competences (id, ref, description, cycle, abstract_domaine_id) VALUES
